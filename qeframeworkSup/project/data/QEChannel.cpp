...
#define DEBUG qDebug () << "QEChannel" << __LINE__ << __FUNCTION__ << "  "
...
int QEChannel::disconnectedCount = 0;
int QEChannel::connectedCount = 0;

// Each created QEChannel is given a unique identity.
//
QEChannel::ObjectIdentity QEChannel::nextObjectIdentity = 0;

//------------------------------------------------------------------------------
// static
int* QEChannel::getDisconnectedCountRef()
{
   return &QEChannel::disconnectedCount;
}

//------------------------------------------------------------------------------
// static
int* QEChannel::getConnectedCountRef()
{
   return &QEChannel::connectedCount;
}
...
//
QEChannel::QEChannel (const QString& newPvName,
                      QObject* parent,
...
//------------------------------------------------------------------------------
//
void QEChannel::initialise (const QString& newPvName,
                            const unsigned int variableIndexIn,
                            UserMessage* userMessageIn,
                            SignalsToSendFlags signalsToSendIn,
                            priorities priorityIn)
{
   ...
   // Allocate a new object identity for this QEChannel.
...
//------------------------------------------------------------------------------
//
QECaClient* QEChannel::asCaClient () const
{
...
//------------------------------------------------------------------------------
//
QEPvaClient* QEChannel::asPvaClient () const
{
...
//------------------------------------------------------------------------------
//
bool QEChannel::isCaChannel () const
{
...
//------------------------------------------------------------------------------
//
bool QEChannel::isPvaChannel () const
{
...
//------------------------------------------------------------------------------
//
void QEChannel::setSignalsToSend (const SignalsToSendFlags signalsToSendIn)
{
   this->signalsToSend = signalsToSendIn;
}
...
//------------------------------------------------------------------------------
//
QEChannel::SignalsToSendFlags QEChannel::getSignalsToSend () const
{
...
//
void QEChannel::clearConnectionState()
{
   // setChannelExpired
...
//
bool QEChannel::dataTypeKnown() const
{
...
//
unsigned int QEChannel::getVariableIndex() const
{
...
// After calling this method the QEChannel can report errors to the user.
//
void QEChannel::setUserMessage (UserMessage* userMessageIn)
{
   this->userMessage = userMessageIn;
...
//
void  QEChannel::setRequestedElementCount (unsigned int elementCount)
{
...
//
bool  QEChannel::getChannelIsConnected () const
{
   return this->client->getIsConnected();
}
...
//
bool QEChannel::getDataIsAvailable() const
{
...
//
bool QEChannel::getIsMetaDataUpdate () const
{
...
//
QString  QEChannel::getStringValue (const QE::ArrayActions arrayAction) const
{
...
//
bool QEChannel::getBooleanValue() const
{
...
//
long  QEChannel::getIntegerValue() const
{
...
//
double QEChannel::getFloatingValue() const
{
   QEFloatingFormatting formatter;
   double result;
...
//
QVector<bool> QEChannel::getBooleanArray () const
{
   QEFloatingFormatting formatter;
   QVector<bool> result;
   QVector<double> temp;
...
//
QVector<long> QEChannel::getIntegerArray () const
{
   QEIntegerFormatting formatter;
   QVector<long> result;
...
//
QVector<double> QEChannel::getFloatingArray () const
{
   QEFloatingFormatting formatter;
...
//------------------------------------------------------------------------------
//
void QEChannel::writeStringValue (const QString& value)
{
   QVariant varData;
...
//------------------------------------------------------------------------------
//
void QEChannel::writeBooleanValue (const bool value)
{
   QVariant varData;
...
//------------------------------------------------------------------------------
//
void QEChannel::writeIntegerValue (const long value)
{
   QVariant varData;
   varData.setValue (value);
   this->writeDataElement (varData);
...
//------------------------------------------------------------------------------
//
void QEChannel::writeFloatingValue (const double value)
{
   QVariant varData;
   varData.setValue (value);
   this->writeDataElement (varData);
...
//------------------------------------------------------------------------------
//
void QEChannel::writeBooleanArray (const QVector<bool>& array)
{
...
//------------------------------------------------------------------------------
//
void QEChannel::writeIntegerArray (const QVector<long>& array)
{
   QVariantList varData;
   for (int j = 0; j < array.count(); j++) {
      QVariant varElement;
...
//------------------------------------------------------------------------------
//
void QEChannel::writeFloatingArray (const QVector<double>& array)
{
   QVariantList varData;
   for (int j = 0; j < array.count(); j++) {
      QVariant varElement;
...
//------------------------------------------------------------------------------
// static
QEChannel::ObjectIdentity QEChannel::nullObjectIdentity ()
{
   return 0;
}
...
//------------------------------------------------------------------------------
//
QEChannel::ObjectIdentity QEChannel::getObjectIdentity () const
{
...
//
QString QEChannel::getPvName() const
{
...
//
QString QEChannel::getRecordName() const
{
   return this->processVariableName;
}
...
//
QString QEChannel::getEgu() const
{
...
//
QString  QEChannel::getHostName() const
{
...
//
bool QEChannel::getReadAccess() const
{
...
//
bool QEChannel::getWriteAccess() const
{
...
//
QString QEChannel::getFieldType() const
{
...
//
unsigned long QEChannel::getHostElementCount() const
{
...
//
unsigned long QEChannel::getDataElementCount() const
{
...
//------------------------------------------------------------------------------
// Obsolete
unsigned long QEChannel::getElementCount() const
{
...
//
int QEChannel::getArrayIndex() const
{
...
//
QStringList QEChannel::getEnumerations() const
{
...
//
unsigned int QEChannel::getPrecision() const
{
...
//
double  QEChannel::getDisplayLimitUpper() const
{
...
//
double  QEChannel::getDisplayLimitLower() const
{
...
//
double  QEChannel::getAlarmLimitUpper() const
{
...
//
double  QEChannel::getAlarmLimitLower() const
{
...
//
double  QEChannel::getWarningLimitUpper() const
{
...
//
double  QEChannel::getWarningLimitLower() const
{
...
//
double  QEChannel::getControlLimitUpper() const
{
...
//
double  QEChannel::getControlLimitLower() const
{
...
//
void QEChannel::enableWriteCallbacks (bool enable)
{
   QECaClient* caClient = this->asCaClient();
   if (caClient)
...
//
bool QEChannel::isWriteCallbacksEnabled() const
{
   QECaClient* caClient = this->asCaClient();
   if (caClient)
...
//
QCaDateTime  QEChannel::getDateTime () const
{
...
//
QString QEChannel::getDescription () const
{
...
//------------------------------------------------------------------------------
//
void QEChannel::checkDeprecatedSignalUsage (const char* varSignal)
{
...
//
void QEChannel::dataUpdate (const bool isMetaUpdateIn)
{
...
//
void QEChannel::putCallbackNotifcation( const bool isSuccessful )
{
...
//
QVariant QEChannel::getVariant () const
{
...
//------------------------------------------------------------------------------
//
QByteArray QEChannel::getByteArray() const
{
...
//------------------------------------------------------------------------------
//
unsigned QEChannel::getDataElementSize () const
{
   const QVariant value = this->getVariant ();
   const bool isVector = QEVectorVariants::isVectorVariant (value);
...
//
void QEChannel::getLastData (bool& isDefinedOut, QVariant& valueOut,
...
//------------------------------------------------------------------------------
//
bool QEChannel::writeEnabled() const
{
...
//
bool QEChannel::writeData (const QVariant& value)
{
...
//
bool QEChannel::writeDataElement (const QVariant& elementValue)
{
...
// This can be used after a property of a widget using this QEChannel has changed to
