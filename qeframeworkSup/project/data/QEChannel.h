...
class QE_FRAMEWORK_LIBRARY_SHARED_EXPORT QEChannel : public QObject {
   Q_OBJECT
...
public:
   ...
   QEChannel (const QString& pvName, QObject *parent,
   ...
   Q_DECL_DEPRECATED_X("use getHostElementCount")
   ...
   //
   QT_DEPRECATED_X("use new signal.isMetaUpdate")
...
signals:
   ...
   //
   void dataChanged (const QVariant&, QCaAlarmInfo&,
                     QCaDateTime&, const unsigned int&);
   void byteArrayChanged (const QByteArray&, unsigned long, QCaAlarmInfo&,
                          QCaDateTime&, const unsigned int&);
...
Q_DECLARE_OPERATORS_FOR_FLAGS (QEChannel::SignalsToSendFlags)
